        ...
        <div className='min-h-screen w-full flex flex-col items-center justify-start bg-transparent py-10 pt-28'>
            ...
            <div className="mb-8 w-full">
                <div className="relative overflow-hidden bg-linear-to-r from-black-soft to-brown-dark/30 border border-white/5 shadow-2xl">
                    ...
                    {/* Info Bar */}
                    <div className="bg-black/40 backdrop-blur-md border-t border-white/5 px-6 py-4 flex flex-row items-center justify-between gap-4 text-xs md:text-sm text-gray-300 relative z-20">
                        <div className="flex items-center gap-2">
                            <CalendarIcon />
                            <span>Saturday, 21st January, 2026</span>
                        </div>
                        <div className="flex items-center gap-2">
                            <ClockIcon />
                        ...
                        <div className="flex items-center gap-2">
                            <LocationIcon />
                            <span>The virtual location of the event</span>
                        </div>
                    </div>
                </div>
            </div>
