...
export default function NotFound() {
  return (
    <main className="grow pb-20 pt-[200px] flex flex-col items-center justify-center text-center px-6 relative overflow-hidden">
      {/* Background Elements */}
      ...
      <div className="relative z-10 max-w-2xl mx-auto">
        <div className="mb-4 flex justify-center items-center gap-4">
          ...
          <h1 className="text-9xl font-bold text-white/20 select-none leading-none">
            404
          </h1>
        </div>
