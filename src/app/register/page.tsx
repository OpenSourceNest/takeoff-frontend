    ...
    return (
        <div className='min-h-screen w-full flex flex-col items-center justify-start bg-transparent py-10'>
            ...
            <div className="mb-12 w-full mx-auto px-6">
                ...
                <div className="max-w-7xl mx-auto border-b border-white/10 p-5 md:py-5 flex flex-col md:flex-row items-center justify-between gap-y-4 text-sm md:text-base text-gray-300 relative z-20">
